...
export class RfidCardController {
  ...
  async getCards(
    ...
    return this.rfidCardService.getCards(tenantId ? +tenantId : undefined, active === 'true');
  }
  ...
  async getReaderWithCards(
    ...
    return this.rfidCardService.getReaderWithCards(+readerId, tenantId ? +tenantId : undefined);
  }

  @Get(':uid')
  async getCard(@Param('uid') uid: string, @Query('tenantId') tenantId?: string) {
    return this.rfidCardService.getCardByUid(uid, tenantId ? +tenantId : undefined);
  }
  ...
  async updateCard(
    ...
    return this.rfidCardService.updateCard(uid, mappedData, tenantId ? +tenantId : undefined);
  }

  @Delete(':uid')
  async deleteCard(@Param('uid') uid: string, @Query('tenantId') tenantId?: string) {
    return this.rfidCardService.deleteCard(uid, tenantId ? +tenantId : undefined);
  }
}
